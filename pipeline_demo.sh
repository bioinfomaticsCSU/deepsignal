...
extract_kmer_signal_py="${BASEDIR}/utils/_extract_kmer_signals.py"
...
python "${BASEDIR}/generate_testing_data.py" -i $signal_feature_reformat_file -o $predict_input_dir -m 60 -b 17 -s 360
